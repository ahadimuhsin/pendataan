...
<body>
          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                  ...
                  <li class="selected"><a href="<?php base_url()?>karyawan"><i class="fa fa-tasks"></i> Karyawan</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <form method="post" action="<?php echo base_url(). 'admin/searchDataKaryawan'; ?>" style="margin-top: -40px">
                    <div class="main-container" align="right">
                        <input placeholder="Search by NIK" class="fixer-container" name="nik" type="text" class="input" id="input01"></input>
                        <button class="btn btn-success" onclick="<?php echo site_url('index.php/Admin/searchDataKaryawan')?>"><i class="glyphicon glyphicon-search"></i></button>
                      </div>
                  </form>
                </br> </br>
                    ...
                    <tbody>
                              ...
                              <td><?php echo $karyawan->nik;?></td>
              				         ...
              				         <td><?php echo $karyawan->kontak;?></td>
              								...
              								<td>
              									<button class="btn btn-warning" onclick="edit_karyawan(<?php echo $karyawan->nik;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
              									<button class="btn btn-danger" onclick="delete_karyawan(<?php echo $karyawan->nik;?>)"><i class="glyphicon glyphicon-remove"></i></button>
    ...
    $(document).ready( function () {
      ...
      function edit_karyawan(id)
      {
        ...
        $.ajax({
          url : "<?php echo site_url('index.php/c_karyawan/ajax_edit/')?>/" + id,
          type: "GET",
          dataType: "JSON",
      ...
      function save()
      {
        ...
        if(save_method == 'add')
        {
            url = "<?php echo site_url('index.php/c_karyawan/karyawan_add')?>";
        }
        else
        {
          url = "<?php echo site_url('index.php/c_karyawan/karyawan_update')?>";
        }
      ...
      function delete_karyawan(id)
      {
        if(confirm('Are you sure delete this data?'))
        {
          // ajax delete data from database
            $.ajax({
              url : "<?php echo site_url('index.php/c_karyawan/karyawan_delete')?>/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
          ...
          <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-body">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input id="disabled" name="nik" placeholder="NIK" class="form-control" type="text">
                </div>
              </div>
              <div class="form-group">
